...
def adversarial_paraphrase_snli(input_text_p, input_text_h, true_y, grad_guide, tokenizer, dataset, level, verbose=True):
    '''
    Compute a perturbation, greedily choosing the synonym if it causes the most
    significant change in the classification probability after replacement
    :return perturbed_text: generated adversarial examples
    ...
    perturbed_text_p, perturbed_text_h, sub_rate, NE_rate, change_tuple_list = PWWS_snli(doc_p, doc_h,
                                                                true_y,
                                                                dataset,
